...
package com.viztushar.flutter_webview_mod;
...
public class WebViewFlutterPlugin implements FlutterPlugin {
  ...
  public static void registerWith(Registrar registrar) {
    registrar
        ...
        .registerViewFactory(
            "com.viztushar.flutter_webview_mod.FlutterWebviewModPlugin/webview",
  ...
  public void onAttachedToEngine(FlutterPluginBinding binding) {
    ...
    binding
        ...
        .getRegistry()
        .registerViewFactory(
            "com.viztushar.flutter_webview_mod.FlutterWebviewModPlugin/webview", new WebViewFactory(messenger, /*containerView=*/ null));
